...
C
C-------- INPUT INTERNAL WAVW SHEAR ENERGY ACCORDING TO ----------------
C--------------- 200*(B.V.FREQ)**3 -------------------------------------
      DO 115 K=2,KBM1
      DO 115 J=2,JMM1
      DO 115 I=2,IMM1
 115  BOYGR(I,J,K)=GEE*(RHO(I,J,K-1)-RHO(I,J,K))/(DZZ(K-1)*DH(I,J))
C
      DO 120 K=2,KBM1
      DO 120 J=2,JMM1
      DO 120 I=2,IMM1
  120 PROD(I,J,K)=KM(I,J,K)*.25*SEF
     .       *( (U(I,J,K)-U(I,J,K-1)+U(I+1,J,K)-U(I+1,J,K-1))**2
     .       +(V(I,J,K)-V(I,J,K-1)+V(I,J+1,K)-V(I,J+1,K-1))**2 )
     .       /(DZZ(K-1)*DH(I,J))**2
     .       +KH(I,J,K)*BOYGR(I,J,K)
C
      DO 110 K=2,KBM1
      DO 110 J=2,JMM1
      DO 110 I=2,IMM1
