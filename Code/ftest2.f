...
c for main project make this part of galgorithm.f
       ...
       subroutine ftest2(trackfile,fscr)
...
c      fscr: fitness score
       ...
       parameter(nfs = 23)   ! # gridcells in test region
       include 'comdeck'
       include 'genetic'
...
c    define cells in which to obtain particle counts
       data ifs/8,8,8,9,9,9,9,
     & 10,10,10,11,11,11,11,11,
     & 12,12,12,12,13,13,13,13/  ! feather sound array indices
       data jfs/21,22,23,20,21,22,23,
